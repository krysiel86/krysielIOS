...
- (instancetype)initWithJsonDictionary:(PBMJsonDictionary *)jsonDictionary {
    ...
    NSLog(@"tpmn PBMORTBBidExt jsonDictionary _prebid : %@ / %@",_prebid,_skadn);
//    NSLog(@"tpmn PBMORTBBidExt jsonDictionary _skadn : %@",_skadn);
...
- (PBMJsonDictionary *)toJsonDictionary {
    ...
    NSLog(@"tpmn PBMORTBBidExt toJsonDictionary");
