...
- (void)buildAd2s:(nonnull NSData *)data {
    NSLog(@"tpmn buildAd2sbuildAd2sbuildAd2sbuildAd2sbuildAd2s %@ ", [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding]);
    
    
    //    NSLog(@"tpmn PBMVastAdsBuilder wrapperAd parsedResponse : %@ ",[[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding]);
...
- (void)buildAds:(nonnull NSData *)data wrapperAd:(PBMVastWrapperAd *)wrapperAd completion:(PBMVastAdsBuilderWrapperCompletionBlock)completionBlock {
    NSLog(@"tpmn PBMVastAdsBuilder wrapperAd ");
...
- (void)requestAds:(NSString *)vastURL
    ...
    NSLog(@"tpmn PBMVastAdsBuilder requestAds ");
...
//        NSLog(@"tpmn PBMVastAdsBuilder requestAds rawData : %@", [[NSString alloc] initWithData: serverResponse.rawData encoding:NSUTF8StringEncoding]);
...
- (NSArray<PBMVastAbstractAd *> *)extractAdsWithError:(NSError *__autoreleasing  _Nullable *)error {
    NSLog(@"tpmn PBMVastAdsBuilder extractAdsWithError ");
