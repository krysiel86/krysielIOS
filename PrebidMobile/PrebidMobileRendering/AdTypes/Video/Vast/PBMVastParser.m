...
- (PBMVastResponse *)parseAdsResponse:(NSData *)data {
    ...
    NSLog(@"tpmn PBMVastParser data : %@",strVast);
...
-(void)parser:(NSXMLParser *)parser didStartElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName attributes:(NSDictionary<NSString *,NSString *> *)attributeDict {
    ...
    NSLog(@"tpmn PBMVastParser parser1 /  %@ ", elementName);
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName {
    NSLog(@"tpmn PBMVastParser parser2 /  %@ ", elementName);
...
-(void)parser:(NSXMLParser *)parser foundCDATA:(NSData *)CDATABlock {
 // this reports a CDATA block to the delegate as an NSData.
    ...
    NSLog(@"tpmn PBMVastParser CDATABlock / %@  ",string);
...
- (id <PBMVastResourceContainerProtocol>)extractCreativeContainer {
    NSLog(@"tpmn PBMVastParser extractCreativeContainer");
