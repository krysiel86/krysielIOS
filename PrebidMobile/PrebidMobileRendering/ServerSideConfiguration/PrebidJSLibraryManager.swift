...
public class PrebidJSLibraryManager: NSObject {
    ...
    public func downloadLibraries() {
        Log.info("PrebidJSLibraryManager downloadLibraries")
    ...
    func fetchLibrary(_ jsLibrary: PrebidJSLibrary) -> String? {
        Log.info("fetchLibrary jsLibrary : \(jsLibrary)")
    ...
    func downloadJSLibrary(
        ...
        DispatchQueue.global(qos: .background).async {
            connection.download(urlString) { [weak self] response in
                ...
                Log.info("tpmn downloadJSLibrary : \(contentsString) ");
    ...
    func saveLibrary(with name: String, contents: String?) {
        ...
        Log.error("tpmn saveLibrary libContentsURL : \(libContentsURL)");
    ...
    func getPath() -> URL? {
        ...
        Log.info("PrebidJSLibraryManager getPath : \(directoryURL)")
