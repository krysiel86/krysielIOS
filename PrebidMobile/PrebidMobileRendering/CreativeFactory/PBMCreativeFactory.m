...
- (void)startFactory {
    NSLog(@"tpmn PBMCreativeFactory startFactory");
...
- (NSArray<PBMCreativeFactoryJob *> *)convertCreativeModels {
    NSLog(@"tpmn PBMCreativeFactory convertCreativeModels");
...
- (void)onFinishedJob:(PBMCreativeFactoryJob *)job error:(NSError *)error {
    NSLog(@"tpmn PBMCreativeFactory onFinishedJob");
  @weakify(self);
...
- (BOOL)allJobsSucceeded {
    NSLog(@"tpmn PBMCreativeFactory allJobsSucceeded");
 for (PBMCreativeFactoryJob *job in self.jobs) {
