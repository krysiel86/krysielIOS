...
//static NSString * const PBMOpenMeasurementJSLibURL      =  @"https://cdn.jsdelivr.net/gh/prebid/prebid-mobile-android@master/scripts/js/omsdk_v1.js";
...
- (instancetype)init {
    self = [super init];
    NSLog(@" tpmn PBMOpenMeasurementWrapper init");
    if (self) {
...
- (nullable NSString *)injectJSLib:(NSString *)html error:(NSError **)error {
    ...
    NSLog(@"tpmn PBMOpenMeasurementWrapper injectJSLib : %@ " , html );
...
- (nullable PBMOpenMeasurementSession *)initializeWebViewSession:(WKWebView *)webView contentUrl:(NSString *)contentUrl {
    ...
    NSLog(@"tpmn PBMOpenMeasurementWrapper initializeWebViewSession %@: " , contentUrl);
    ...
    NSLog(@"tpmn PBMOpenMeasurementWrapper config : %@ " , config);
    ...
    NSLog(@"tpmn PBMOpenMeasurementWrapper session : %@ " , session);
//    PBMLogInfo(@"tpmn Bid Response: %@", [[NSString alloc] initWithData:serverResponse.rawData encoding:NSUTF8StringEncoding]);
...
- (PBMOpenMeasurementSession *)initializeNativeVideoSession:(UIView *)videoView
    ...
    NSLog(@"tpmn initializeNativeVideoSession" );
...
- (PBMOpenMeasurementSession *)initializeNativeDisplaySession:(UIView *)view
    ...
    NSLog(@"tpmn Open Measurement SDK ");
...
- (nonnull NSArray<OMIDPrebidorgVerificationScriptResource *> *)scriptResourcesFrom:(NSString *)omidJSUrl
    ...
    NSLog(@" tpmn  scriptResourcesFrom  ");
