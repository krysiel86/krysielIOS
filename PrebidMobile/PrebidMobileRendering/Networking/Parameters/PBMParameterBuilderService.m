...
+ (nonnull NSDictionary<NSString* , NSString *> *)buildParamsDictWithAdConfiguration:(nonnull PBMAdConfiguration *)adConfiguration {
    NSLog(@"tpmn PBMParameterBuilderService buildParamsDictWithAdConfiguration");
...
+ (nonnull PBMORTBBidRequest *)createORTBBidRequestWithTargeting:(nonnull Targeting *)targeting {
    ...
    NSLog(@"tpmn PBMParameterBuilderService createORTBBidRequestWithTargeting");
    ...
    NSLog(@"tpmn PBMParameterBuilderService createORTBBidRequestWithTargeting bidRequest %@", bidRequest);
    //    PBMLogInfo(@"tpmn Bid Response: %@", [[NSString alloc] initWithData:bidRequest encoding:NSUTF8StringEncoding]);
